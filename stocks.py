"""
Модуль для извлечения данных с api yahoo.finance
"""
import json
import sqlite3
...
class Company:
    """Основной класс для работы с сущностью компания
    """
    ...
    def __get_price(self, start=0, end=9999999999, interval="1d"):
        if not self.error:
            result = requests.get(
